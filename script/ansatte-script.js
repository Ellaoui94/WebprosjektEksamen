    ...
    <article class="column is-one-fifth">
        ...
        <div id="search-test" class="card">
            ...
            <section class="card-footer">
                ...
                <button type="button" id="show-all-button" class="button show-all-button card-footer-item">Alle ansatte</button>
            </section>
        </div>
    </article>
`;
                    ...
                    <section class="card-content">
                        <ul class="content">
                            ...
                            <li>
                                ...
                                <div class="control">
                                    <input id="popupLeder${ansatte.id}" type="text" class="input edit-input stillingsprosent" placeholder="${ansatte.stillingsprosent}">
                                </div>
                            </li>
                            <li>
                                <label class="label">Timelønn</label>
                                <div class="control">
                                    <input id="popupLeder${ansatte.id}" type="text" class="input edit-input timelønn" placeholder="${ansatte.timelønn}">
                                </div>
                            </li>
                            <li>
